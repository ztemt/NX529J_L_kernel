...
#define CYTTSP568_LOADER_NAME "cyttsp5_loader"
...
#define CYTTSP568_AUTO_LOAD_FOR_CORRUPTED_FW 1
#define CYTTSP568_LOADER_FW_UPGRADE_RETRY_COUNT 3

#define CYTTSP568_FW_UPGRADE \
	(defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_PLATFORM_FW_UPGRADE) \
	|| defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_BINARY_FW_UPGRADE))

#define CYTTSP568_TTCONFIG_UPGRADE \
	(defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_PLATFORM_TTCONFIG_UPGRADE) \
	|| defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_MANUAL_TTCONFIG_UPGRADE))
...
//#if CYTTSP568_FW_UPGRADE || CYTTSP568_TTCONFIG_UPGRADE
#if CYTTSP568_TTCONFIG_UPGRADE
/***ZTEMT END***/
...
#endif /* CYTTSP568_FW_UPGRADE || CYTTSP568_TTCONFIG_UPGRADE */

#if CYTTSP568_FW_UPGRADE
...
{
	struct cyttsp5_loader_data *ld = cyttsp5_get_loader_data(dev);
	int retry = CYTTSP568_LOADER_FW_UPGRADE_RETRY_COUNT;
		...
		struct cyttsp5_touch_firmware *fw)
{
	...
	if (!ld->si) {
		dev_info(dev, "%s: No firmware infomation found, device FW may be corrupted\n",
			__func__);
		return CYTTSP568_AUTO_LOAD_FOR_CORRUPTED_FW;
	}
...
#endif /* CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_PLATFORM_FW_UPGRADE */
...
#endif /* CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_BINARY_FW_UPGRADE */
...
#endif /* CYTTSP568_TTCONFIG_UPGRADE */
...
#endif /* CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_PLATFORM_TTCONFIG_UPGRADE */
...
#endif /* CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_MANUAL_TTCONFIG_UPGRADE */
