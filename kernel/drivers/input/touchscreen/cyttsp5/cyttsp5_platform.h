...
#ifndef _LINUX_CYTTSP568_PLATFORM_H
#define _LINUX_CYTTSP568_PLATFORM_H

#include "cyttsp5_core.h"

#if defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568) \
	|| defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568_MODULE)
...
#else /* !CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568 */
...
#endif /* CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP568 */

#endif /* _LINUX_CYTTSP568_PLATFORM_H */
